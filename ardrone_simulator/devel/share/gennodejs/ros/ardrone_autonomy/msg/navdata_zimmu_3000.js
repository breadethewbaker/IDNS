...
class navdata_zimmu_3000 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('vzimmuLSB')) {
        this.vzimmuLSB = initObj.vzimmuLSB
      }
      else {
        this.vzimmuLSB = 0;
      }
      if (initObj.hasOwnProperty('vzfind')) {
        this.vzfind = initObj.vzfind
      }
      else {
        this.vzfind = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [vzimmuLSB]
    bufferOffset = _serializer.int32(obj.vzimmuLSB, buffer, bufferOffset);
    // Serialize message field [vzfind]
    bufferOffset = _serializer.float32(obj.vzfind, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new navdata_zimmu_3000(null);
    ...
    // Deserialize message field [vzimmuLSB]
    data.vzimmuLSB = _deserializer.int32(buffer, bufferOffset);
    // Deserialize message field [vzfind]
    data.vzfind = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new navdata_zimmu_3000(null);
    ...
    if (msg.vzimmuLSB !== undefined) {
      resolved.vzimmuLSB = msg.vzimmuLSB;
    }
    else {
      resolved.vzimmuLSB = 0
    }

    if (msg.vzfind !== undefined) {
      resolved.vzfind = msg.vzfind;
    }
    else {
      resolved.vzfind = 0.0
    }
...
module.exports = navdata_zimmu_3000;

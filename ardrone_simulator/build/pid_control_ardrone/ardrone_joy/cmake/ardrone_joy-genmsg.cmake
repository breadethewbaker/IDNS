...
set(MSG_I_FLAGS "-Iardrone_joy:/home/vlad/ardrone_simulator/src/pid_control_ardrone/ardrone_joy/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/vlad/ardrone_simulator/src/pid_control_ardrone/ardrone_joy/msg/IntList.msg" NAME_WE)
add_custom_target(_ardrone_joy_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ardrone_joy" "/home/vlad/ardrone_simulator/src/pid_control_ardrone/ardrone_joy/msg/IntList.msg" ""
)

get_filename_component(_filename "/home/vlad/ardrone_simulator/src/pid_control_ardrone/ardrone_joy/msg/AutoPilotCmd.msg" NAME_WE)
add_custom_target(_ardrone_joy_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ardrone_joy" "/home/vlad/ardrone_simulator/src/pid_control_ardrone/ardrone_joy/msg/AutoPilotCmd.msg" ""
)

get_filename_component(_filename "/home/vlad/ardrone_simulator/src/pid_control_ardrone/ardrone_joy/srv/GoToPose.srv" NAME_WE)
add_custom_target(_ardrone_joy_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ardrone_joy" "/home/vlad/ardrone_simulator/src/pid_control_ardrone/ardrone_joy/srv/GoToPose.srv" ""
)
...
_generate_srv_cpp(ardrone_joy
  "/home/vlad/ardrone_simulator/src/pid_control_ardrone/ardrone_joy/srv/GoToPose.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/ardrone_joy
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ardrone_joy)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ardrone_joy\")")
  # install generated code
  install(

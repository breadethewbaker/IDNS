...
class navdata_adc_data_frame {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.uint8(obj.data_frame, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new navdata_adc_data_frame(null);
    ...
    data.data_frame = _arrayDeserializer.uint8(buffer, bufferOffset, null)
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new navdata_adc_data_frame(null);
...
module.exports = navdata_adc_data_frame;
